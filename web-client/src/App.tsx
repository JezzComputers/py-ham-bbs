...
function App() {
	...
	return (
		<main className="h-dvh bg-background p-1 md:p-2">
			<div className="mx-auto flex h-full w-[98vw] flex-col gap-3">
				...
				<Textarea
					value={inboundText}
					readOnly
					placeholder="Packet log"
					className="min-h-0 flex-1 resize-none font-mono text-[0.95rem] leading-5"
				/>
			</div>
		</main>
	);
